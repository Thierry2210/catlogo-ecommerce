        ...
        <div v-else
            ...
            <div class="flex flex-col justify-center px-6 py-8 md:px-10 md:py-12">
                ...
                <div class="flex gap-4 mt-4">
                    <button
                        class="bg-pink-600 hover:bg-pink-700 text-white px-6 py-3 rounded-lg font-semibold shadow transition-all duration-200 flex items-center gap-2">
                    ...
                    <button
                        class="bg-white border border-pink-600 text-pink-600 px-6 py-3 rounded-lg font-semibold shadow hover:bg-pink-50 transition-all duration-200">
...
onMounted(async () => {
    ...
    try {
        ...
        // Busca produtos similares da mesma categoria, excluindo o atual
